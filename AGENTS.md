...
The root README is client- and recruiter-facing. Keep it concise and let the dashboard work speak. Use it for the live portfolio link, industry navigation, and project catalog; avoid repetitive explanation, explicit claims about taste/skill, internal build steps, publishing commands, or agent workflow instructions. Keep those in `AGENTS.md` or project memory files instead of the public README.
